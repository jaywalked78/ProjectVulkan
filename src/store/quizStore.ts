...
export const useQuizStore = create<QuizStore>()(
  devtools(
    (set, get) => ({
      ...
      submitAnswer: () => {
        const { currentCard, userAnswer, deck, currentTurn, uniqueQuestionsAnswered } = get()
...
function selectNextCard(deck: Card[], turn: number): Card {
  ...
  // Second priority: cards that haven't been answered correctly yet (in original order)
  ...
  // Third priority: any available cards (in original order)
